...
<nav class="top">
    ...
    <div class="menu-btn">
        <button class="Event_Menu blink"><a class="scroll" href="#fm-box">무료 PDF 다운로드</a></button>
        ...
        <div class="top">
            <div>
                ...
                <a class="logo"  target="_self" href="./index.html">
                    <img id="menu_logo" src="img/navi_book.png" style="width:20px !important;margin-right:4px;margin-bottom:4px;">
                    <p class="logo-font" id="menu_text"  style="margin:0px;"> 나비출판</p>
                  <!-- <img alt="" src="img/logo_img.png" > -->
                </a>
